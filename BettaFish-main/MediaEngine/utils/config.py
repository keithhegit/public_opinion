...
class Settings(BaseSettings):
    ...
    MINDSPIDER_BASE_URL: Optional[str] = Field("https://api.z.ai/api/paas/v4/", description="MindSpider LLM接口BaseUrl，GLM API的OpenAI兼容端点")
    MINDSPIDER_MODEL_NAME: str = Field("glm-4.6", description="MindSpider LLM模型名称，使用 glm-4.6")
